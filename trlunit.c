...
# 612 "trlunit.m"
if((objcT78=(id)self,(*(BOOL(*)(id,SEL))_imp(objcT78,selTransTbl[30]))(objcT78,selTransTbl[30]))&&(strcmp(o_mainfun,"main"))){
...
(objcT81=(id)self,(*_imp(objcT81,selTransTbl[33]))(objcT81,selTransTbl[33]));
# 635 "trlunit.m"
if((objcT82=(id)self,(*(BOOL(*)(id,SEL))_imp(objcT82,selTransTbl[30]))(objcT82,selTransTbl[30]))){
...
if((objcT83=(id)self,(*(BOOL(*)(id,SEL))_imp(objcT83,selTransTbl[30]))(objcT83,selTransTbl[30]))){
...
# 670 "trlunit.m"
(objcT84=curclassdef,(*_imp(objcT84,selTransTbl[34]))(objcT84,selTransTbl[34]));
}
if(o_comments){
gs("\n/* objc epilogue */\n");
}else{
...
if((e=(objcT85=(id)self,(*_imp(objcT85,selTransTbl[24]))(objcT85,selTransTbl[24])))){
id objcT86;

# 679 "trlunit.m"
(objcT86=e,(*(id(*)(id,SEL,SEL))_imp(objcT86,selTransTbl[25]))(objcT86,selTransTbl[25],selTransTbl[35]));
}
if(o_fwd){
id objcT87,objcT88,objcT89;

# 682 "trlunit.m"
(objcT87=(id)self,(*_imp(objcT87,selTransTbl[36]))(objcT87,selTransTbl[36]));
(objcT88=(id)self,(*_imp(objcT88,selTransTbl[37]))(objcT88,selTransTbl[37]));
(objcT89=(id)self,(*_imp(objcT89,selTransTbl[38]))(objcT89,selTransTbl[38]));
}else{
id objcT90;
...
# 690 "trlunit.m"
(objcT91=(id)self,(*_imp(objcT91,selTransTbl[39]))(objcT91,selTransTbl[39]));
}
(objcT92=(id)self,(*_imp(objcT92,selTransTbl[40]))(objcT92,selTransTbl[40]));
(objcT93=(id)self,(*_imp(objcT93,selTransTbl[41]))(objcT93,selTransTbl[41]));

if(o_postlink){
id objcT94;

# 696 "trlunit.m"
(objcT94=(id)self,(*_imp(objcT94,selTransTbl[42]))(objcT94,selTransTbl[42]));
}else{
id objcT95;

# 698 "trlunit.m"
(objcT95=(id)self,(*_imp(objcT95,selTransTbl[43]))(objcT95,selTransTbl[43]));
}
...
# 702 "trlunit.m"
(objcT96=(id)self,(*_imp(objcT96,selTransTbl[44]))(objcT96,selTransTbl[44]));
}
gc('\n');
gc('\n');
o_nolinetags--;
...
# 712 "trlunit.m"
if(self->builtintypes!=(id)0&&(objcT97=self->builtintypes,(*_imp(objcT97,selTransTbl[45]))(objcT97,selTransTbl[45],node))!=(id)0)
return(BOOL)1;
if(self->types!=(id)0&&(objcT98=self->types,(*(BOOL(*)(id,SEL,id))_imp(objcT98,selTransTbl[46]))(objcT98,selTransTbl[46],node)))
return(BOOL)1;
return(BOOL)0;
}
...
# 721 "trlunit.m"
return self->builtinfuns!=(id)0&&(objcT99=self->builtinfuns,(*_imp(objcT99,selTransTbl[45]))(objcT99,selTransTbl[45],node))!=(id)0;
}
...
builtinfuns=(objcT100=Set,(*_imp(objcT100,selTransTbl[3]))(objcT100,selTransTbl[3]));
(objcT101=self->builtinfuns,(*_imp(objcT101,selTransTbl[11]))(objcT101,selTransTbl[11],node));
return(id)self;
}
...
builtintypes=(objcT102=Set,(*_imp(objcT102,selTransTbl[3]))(objcT102,selTransTbl[3]));
(objcT103=self->builtintypes,(*_imp(objcT103,selTransTbl[11]))(objcT103,selTransTbl[11],node));
return(id)self;
}
...
self->
# 743 "trlunit.m"
typedic=(objcT104=Dictionary,(*_imp(objcT104,selTransTbl[3]))(objcT104,selTransTbl[3]));self->
types=(objcT105=Set,(*_imp(objcT105,selTransTbl[3]))(objcT105,selTransTbl[3]));
}
if(o_debuginfo){
id objcT106,objcT107;

# 747 "trlunit.m"
fprintf(stderr,"typedef %s as '",(objcT106=node,(*(STR(*)(id,SEL))_imp(objcT106,selTransTbl[18]))(objcT106,selTransTbl[18])));
gstderr();
(objcT107=aType,(*_imp(objcT107,selTransTbl[47]))(objcT107,selTransTbl[47]));
gnormal();
fprintf(stderr,"'\n");
}
(objcT108=self->types,(*_imp(objcT108,selTransTbl[11]))(objcT108,selTransTbl[11],node));
(void)0;
(objcT109=self->typedic,(*_imp(objcT109,selTransTbl[15]))(objcT109,selTransTbl[15],node,aType));
return(id)self;
}
...
enumtors=(objcT110=Set,(*_imp(objcT110,selTransTbl[3]))(objcT110,selTransTbl[3]));
(objcT111=self->enumtors,(*_imp(objcT111,selTransTbl[11]))(objcT111,selTransTbl[11],e));
return(id)self;
}
...
# 769 "trlunit.m"
return(self->enumtors)?(objcT112=self->enumtors,(*_imp(objcT112,selTransTbl[45]))(objcT112,selTransTbl[45],sym)):(id)0;
}
...
structdefs=(objcT113=Set,(*_imp(objcT113,selTransTbl[3]))(objcT113,selTransTbl[3]));
(objcT114=self->structdefs,(*_imp(objcT114,selTransTbl[11]))(objcT114,selTransTbl[11],e));
return(id)self;
}
...
# 782 "trlunit.m"
return(self->structdefs)?(objcT115=self->structdefs,(*_imp(objcT115,selTransTbl[45]))(objcT115,selTransTbl[45],e)):(id)0;
}
...
# 787 "trlunit.m"
return(self->typedic)?(objcT116=self->typedic,(*_imp(objcT116,selTransTbl[13]))(objcT116,selTransTbl[13],sym)):(id)0;
}
...
# 792 "trlunit.m"
return(self->globaldic)?(objcT117=self->globaldic,(*_imp(objcT117,selTransTbl[13]))(objcT117,selTransTbl[13],sym)):(id)0;
}
...
# 797 "trlunit.m"
return(self->defdic)?(objcT118=self->defdic,(*_imp(objcT118,selTransTbl[13]))(objcT118,selTransTbl[13],sym)):(id)0;
}
...
self->
# 803 "trlunit.m"
defdic=(objcT119=Dictionary,(*_imp(objcT119,selTransTbl[3]))(objcT119,selTransTbl[3]));
}
(objcT120=self->defdic,(*_imp(objcT120,selTransTbl[15]))(objcT120,selTransTbl[15],sym,d));
return(id)self;
}
...
# 811 "trlunit.m"
if( !self->globaldic){
id objcT121,objcT122;
self->
# 812 "trlunit.m"
globaldic=(objcT121=Dictionary,(*_imp(objcT121,selTransTbl[3]))(objcT121,selTransTbl[3]));self->
globals=(objcT122=Set,(*_imp(objcT122,selTransTbl[3]))(objcT122,selTransTbl[3]));
}
(objcT123=self->globals,(*_imp(objcT123,selTransTbl[11]))(objcT123,selTransTbl[11],node));
(void)0;
(objcT124=self->globaldic,(*_imp(objcT124,selTransTbl[15]))(objcT124,selTransTbl[15],node,aType));
return(id)self;
}
...
classdefs=(objcT125=Dictionary,(*_imp(objcT125,selTransTbl[3]))(objcT125,selTransTbl[3]));
(objcT126=self->classdefs,(*_imp(objcT126,selTransTbl[15]))(objcT126,selTransTbl[15],sym,classdef));
return(id)self;
}
...
# 831 "trlunit.m"
return(objcT127=self->classdefs,(*_imp(objcT127,selTransTbl[13]))(objcT127,selTransTbl[13],sym));
}
...
# 836 "trlunit.m"
return(objcT128=self->methods,(*_imp(objcT128,selTransTbl[13]))(objcT128,selTransTbl[13],sel));
}
...
methods=(objcT129=Dictionary,(*_imp(objcT129,selTransTbl[3]))(objcT129,selTransTbl[3]));
(objcT130=self->methods,(*_imp(objcT130,selTransTbl[15]))(objcT130,selTransTbl[15],sel,method));
return(id)self;
}
...
gentypes=(objcT131=Set,(*_imp(objcT131,selTransTbl[3]))(objcT131,selTransTbl[3]));
(objcT132=self->gentypes,(*_imp(objcT132,selTransTbl[11]))(objcT132,selTransTbl[11],s));
return(id)self;
}
...
# 857 "trlunit.m"
return(objcT133=self->gentypes,(*(BOOL(*)(id,SEL,id))_imp(objcT133,selTransTbl[46]))(objcT133,selTransTbl[46],s));
}
...
# 862 "trlunit.m"
if(self->clsimpl)(objcT134=self->clsimpl,(*_imp(objcT134,selTransTbl[48]))(objcT134,selTransTbl[48]));
if(self->clsimpls)(objcT135=self->clsimpls,(*(id(*)(id,SEL,SEL))_imp(objcT135,selTransTbl[25]))(objcT135,selTransTbl[25],_cmd));
return(id)self;
}
...
# 869 "trlunit.m"
id v,s;
v=(objcT136=self->defdic,(*_imp(objcT136,selTransTbl[49]))(objcT136,selTransTbl[49]));
while((s=(objcT137=v,(*_imp(objcT137,selTransTbl[29]))(objcT137,selTransTbl[29]))))(objcT138=s,(*_imp(objcT138,selTransTbl[50]))(objcT138,selTransTbl[50]));
return(id)self;
}
...
{
id objcT139,objcT140,objcT141,objcT144,objcT145;

# 886 "trlunit.m"
FILE*f;
id sorted;
id c,classes;
sorted=(objcT139=SortCltn,(*_imp(objcT139,selTransTbl[3]))(objcT139,selTransTbl[3]));
classes=(objcT140=self->classdefs,(*_imp(objcT140,selTransTbl[49]))(objcT140,selTransTbl[49]));
while((c=(objcT141=classes,(*_imp(objcT141,selTransTbl[29]))(objcT141,selTransTbl[29])))){
id objcT142,objcT143;

# 892 "trlunit.m"
(objcT142=sorted,(*_imp(objcT142,selTransTbl[11]))(objcT142,selTransTbl[11],c));
(objcT143=c,(*_imp(objcT143,selTransTbl[51]))(objcT143,selTransTbl[51]));
}
...
printf("menu=Classes\n");
classes=(objcT144=sorted,(*_imp(objcT144,selTransTbl[28]))(objcT144,selTransTbl[28]));
while((c=(objcT145=classes,(*_imp(objcT145,selTransTbl[29]))(objcT145,selTransTbl[29])))){
id objcT146,objcT147;

# 903 "trlunit.m"
printf("name='%s'\n",(objcT146=c,(*(char*(*)(id,SEL))_imp(objcT146,selTransTbl[19]))(objcT146,selTransTbl[19])));
printf("action=open Menu.%s\n",(objcT147=c,(*(char*(*)(id,SEL))_imp(objcT147,selTransTbl[19]))(objcT147,selTransTbl[19])));
}
fclose(f);
return(id)self;
}
...
{
id objcT148,objcT149,objcT150;

# 912 "trlunit.m"
id sorted;
id c,classes;
sorted=(objcT148=SortCltn,(*_imp(objcT148,selTransTbl[3]))(objcT148,selTransTbl[3]));
classes=(objcT149=self->classdefs,(*_imp(objcT149,selTransTbl[49]))(objcT149,selTransTbl[49]));
while((c=(objcT150=classes,(*_imp(objcT150,selTransTbl[29]))(objcT150,selTransTbl[29])))){
id objcT151,objcT152;

# 917 "trlunit.m"
if((objcT151=c,(*_imp(objcT151,selTransTbl[52]))(objcT151,selTransTbl[52]))==s)(objcT152=sorted,(*_imp(objcT152,selTransTbl[11]))(objcT152,selTransTbl[11],c));
}
return sorted;
}
...
{
id objcT153,objcT154,objcT155,objcT158,objcT159;
id objcT167,objcT168,objcT169;
...
classes=(objcT153=c,(*_imp(objcT153,selTransTbl[28]))(objcT153,selTransTbl[28]));
subclasses=(objcT154=OrdCltn,(*_imp(objcT154,selTransTbl[3]))(objcT154,selTransTbl[3]));
while((d=(objcT155=classes,(*_imp(objcT155,selTransTbl[29]))(objcT155,selTransTbl[29])))){
id objcT156,objcT157;

# 939 "trlunit.m"
(objcT156=subclasses,(*_imp(objcT156,selTransTbl[11]))(objcT156,selTransTbl[11],(objcT157=(id)self,(*_imp(objcT157,selTransTbl[53]))(objcT157,selTransTbl[53],d))));
}

i=0;
classes=(objcT158=c,(*_imp(objcT158,selTransTbl[28]))(objcT158,selTransTbl[28]));
while((d=(objcT159=classes,(*_imp(objcT159,selTransTbl[29]))(objcT159,selTransTbl[29])))){
id objcT160,objcT161;

# 945 "trlunit.m"
e=(objcT160=subclasses,(*(id(*)(id,SEL,unsigned))_imp(objcT160,selTransTbl[17]))(objcT160,selTransTbl[17],i++));
if((objcT161=e,(*(unsigned(*)(id,SEL))_imp(objcT161,selTransTbl[12]))(objcT161,selTransTbl[12]))){
id objcT162,objcT163,objcT164;
...
printf("lininfo='%s'\n",(objcT166=d,(*(char*(*)(id,SEL))_imp(objcT166,selTransTbl[19]))(objcT166,selTransTbl[19])));
printf("action=none\n");
}
}
(objcT167=(id)self,(*_imp(objcT167,selTransTbl[54]))(objcT167,selTransTbl[54]));
fclose(f);

i=0;
classes=(objcT168=c,(*_imp(objcT168,selTransTbl[28]))(objcT168,selTransTbl[28]));
while((d=(objcT169=classes,(*_imp(objcT169,selTransTbl[29]))(objcT169,selTransTbl[29])))){
id objcT170,objcT171;

# 962 "trlunit.m"
e=(objcT170=subclasses,(*(id(*)(id,SEL,unsigned))_imp(objcT170,selTransTbl[17]))(objcT170,selTransTbl[17],i++));
if((objcT171=e,(*(unsigned(*)(id,SEL))_imp(objcT171,selTransTbl[12]))(objcT171,selTransTbl[12]))){
id objcT172,objcT173,objcT174,objcT175,objcT176;

# 964 "trlunit.m"
id fn=(objcT172=String,(*(id(*)(id,SEL,STR,...))_imp(objcT172,selTransTbl[4]))(objcT172,selTransTbl[4],"Menu.sub%s",(objcT173=d,(*(char*(*)(id,SEL))_imp(objcT173,selTransTbl[19]))(objcT173,selTransTbl[19]))));
(objcT174=(id)self,(*(id(*)(id,SEL,id,char*,char*))_imp(objcT174,selTransTbl[55]))(objcT174,selTransTbl[55],e,(objcT175=fn,(*(STR(*)(id,SEL))_imp(objcT175,selTransTbl[18]))(objcT175,selTransTbl[18])),(objcT176=d,(*(char*(*)(id,SEL))_imp(objcT176,selTransTbl[19]))(objcT176,selTransTbl[19]))));
}
}
...
{
id objcT177,objcT178,objcT179,objcT180;
...
rootclasses=(objcT179=(id)self,(*_imp(objcT179,selTransTbl[53]))(objcT179,selTransTbl[53],(id)0));
(objcT180=(id)self,(*(id(*)(id,SEL,id,char*,char*))_imp(objcT180,selTransTbl[55]))(objcT180,selTransTbl[55],rootclasses,"Menu.root","Root"));
return(id)self;
}
extern id  Object;
